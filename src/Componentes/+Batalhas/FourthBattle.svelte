...
onMount(() => {
      ...
      let dado3 = Math.floor(Math.random() * 11)
        ...
        function ataqueEnemy(){
          setTimeout(() => {
            ...
            if(dado4 <= 4){
              ...
              hpadam = prota.hp;
              textoExibido.set('Seu inimigo usou Foguetes de Eletroímã!');
        ...
        textoExibido.set('');
          ...
          winorOver();
              ...
              hpadam = prota.hp;
            textoExibido.set('Seu inimigo usou Adagas Cyberneticas!');
        ...
        textoExibido.set('');
          ...
          winorOver();
            ...
            hpadam = prota.hp;
            textoExibido.set('Seu inimigo combou com Foguete Cósmico!');
  ...
  <audio autoplay loop src="./audio/batalha4.mp3" />
    ...
    >
      <div class="black">
        <button
          ...
          class="menu"
          on:click={() => trocarEstadoDoJogo("end")}
        >
          Próximo (provisorio)
        </button>
  
        <h1 class="txt2">THE END</h1>
        ...
        <div>
          <div class="box" id="imgAdam">
            ...
            <img class:adamimg={blinking} src="./images/adam.gif" alt="Adam" style="width: 250px; height: 220px; margin-top: 9%;"/>
          </div>
          ...
          <div class="box" id="imgInimigo">
            ...
            <p class="presetname">Akuma</p>
            <img class:inmg={blinking2} src="./images/boss.gif" alt="Inimigo" style="width: 250px; height: 250px; margin-top: 30px;"/>
          </div>
        </div>
            ...
            <div class="container">
              ...
              <div class="item tooltip">
                <span class="tooltiptext"
                  >Dispara três foguetes em sequência! <br> 95% de acerto</span
                >
              ...
              <div class="item tooltip">
                <span class="tooltiptext">Rajada de tiros feitos de sucata! <br> 60% de acerto</span>
              ...
              <div class="item tooltip">
                <span class="tooltiptext">Constroi uma estação de cura! <br> 90% de acerto</span>
